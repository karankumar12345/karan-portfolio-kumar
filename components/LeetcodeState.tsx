...
// Dynamically import `leetcode-calendar` only on the client
const LeetCodeCalendar = dynamic(() => import("leetcode-calendar"), { ssr: false });
...
const LeetCodeStats = () => {
  ...
  const exampleTheme = {
    light: ["rgb(20, 20, 20)", "rgba(0, 0, 0, 0.44)", "rgba(0, 0, 0, 0.6)", "rgba(0, 0, 0, 0.76)", "rgba(0, 0, 0, 0.92)"],
    dark: ["rgb(20, 20, 20)", "rgba(0, 0, 0, 0.44)", "rgba(0, 0, 0, 0.6)", "rgba(0, 0, 0, 0.76)", "rgba(0, 0, 0, 0.92)"],
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center my-10 overflow-hidden px-4">
      ...
      <div className="w-full max-w-4xl p-4 bg-gray-900 rounded-xl text-white overflow-x-auto">
        <LeetCodeCalendar
          username="Karan1_2"
          blockSize={typeof window !== "undefined" && window.innerWidth < 640 ? 15 : 8} // Adjust size for small screens
          blockMargin={typeof window !== "undefined" && window.innerWidth < 640 ? 7 : 5} // Adjust margin for small screens
          fontSize={typeof window !== "undefined" && window.innerWidth < 640 ? 16 : 15} // Adjust font size for readability
          theme={exampleTheme}
        />
      </div>
